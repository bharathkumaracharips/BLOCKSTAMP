...
contract RecordAttendanceOfStudent {
    ...
    // Function to get the list of students for a given section
    function getStudents(string memory _section) public view returns (string[] memory) {
        if (compareStrings(_section, "Section A")) {
            return sectionA;
        } else if (compareStrings(_section, "Section B")) {
            return sectionB;
        } else if (compareStrings(_section, "Section C")) {
            return sectionC;
        } else if (compareStrings(_section, "Section D")) {
            return sectionD;
        } else {
            revert("Invalid section");
        }
